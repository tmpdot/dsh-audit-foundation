 ...
 * @param {{sessionId?: string}} [options] - sessionId 缺省取事件自带字段。
 * @returns {Array<{sessionId: string, category: string, eventType: string,
 *   source: 'harness', turn?: number, step?: number, callId?: string,
 *   payload: object}>}
 */
export function deriveAuditDrafts(events, { sessionId } = {}) {
