...
| S9 | Audit record field naming | audit domain draft v1 (category/eventType/eventTypeId?/payload/prevHash/identity fields) | T4 | See T4-3 | **Decided 2026-08-21 (original eventType kept; numeric mapping = future direction); migration groundwork landed (event-registry.mjs + optional eventTypeId + frozen gate)** | 2026-08 |
